...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // const coverImageLocalPath=req.files?.coverImage[0]?.path; // there must be some error with trhis line  so change it in future
...
// If there is any issue with the under part then just change it in the future for now go on
...
export {
  ...
  , updateAccountDetails, updateUserAvatar, updateUserCoverImage,getWatchHistory,getUserChannelProfile
}
